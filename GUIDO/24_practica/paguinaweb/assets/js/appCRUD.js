...
const cargarContactos=async()=>{
  ...
  resultado.data.forEach(fila => {
    ...
    <td>${fila[4]}</td>
    <td>${fila[5]}</td>
    <td><button class="btn btn-primary" id="Boton" type="submit"  data-bs-toggle="modal" data-bs-target="#editarModal" onclick="cargarContacto(${fila[0]})"><i class="bi bi-pencil-fill p-1"></i>Editar</button></td>
    <td><button class="btn btn-danger" id="Boton" type="submit" onclick="eliminarContacto(${fila[0]})"><i class="bi bi-trash-fill p-1"></i>Eliminar</button></td>
    </tr>
    `;
  });
